...
?><section class="hero"><div class="hero__grid"><div class="hero__image-wrap"><img src="<?php echo esc_url($img1); ?>" alt="نشیمن مدرن" width="<?php echo (int)$img1_w; ?>" height="<?php echo (int)$img1_h; ?>" fetchpriority="high" decoding="async"></div><div class="hero__image-wrap"><img src="<?php echo esc_url($img2); ?>" alt="اتاق خواب" width="<?php echo (int)$img2_w; ?>" height="<?php echo (int)$img2_h; ?>" loading="lazy" fetchpriority="low" decoding="async"></div></div><div class="hero__content"><div class="hero__content-inner"><p class="hero__kicker">زیبایی در سادگی، کیفیت در جزئیات</p><h1 class="hero__title"><?php echo esc_html($hero_title); ?></h1><p class="hero__subtitle"><?php echo esc_html($hero_subtitle); ?></p><div class="hero__actions"><a href="<?php echo class_exists('WooCommerce')?get_permalink(wc_get_page_id('shop')):'#'; ?>" class="btn btn--primary">مشاهده محصولات</a><a href="#" class="hero__btn-outline">مشاهده مجموعه‌ها</a></div></div></div></section>