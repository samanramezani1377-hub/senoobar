...
for ($i = 1; $i <= 3; $i++)
    $tms[] = [
        'name'  => get_theme_mod("senoobar_tm{$i}_author", ['سارا احمدی', 'رضا کریمی', 'مریم توکلی'][$i - 1]),
        'city'  => ['تهران', 'اصفهان', 'شیراز'][$i - 1],
        'text'  => get_theme_mod("senoobar_tm{$i}_text", [
            'مبلمان‌هایی با کیفیت عالی و خدمات ارسال سریع. تجربه خرید از سنوبر بی‌نظیر بود.',
            'ارسال سریع و بسته‌بندی عالی! کیفیت محصول دقیقاً همان چیزی بود که انتظار داشتم.',
            'کیفیت مبلمان فوق‌العاده است. رنگ و جنس از چیزی که توی عکس می‌دیدم هم بهتر بود.'
        ][$i - 1]),
