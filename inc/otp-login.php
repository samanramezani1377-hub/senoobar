...
/**
 * پس از ثبت سفارش مهمان، اگر حساب جدیدی ساخته شد، رمز عبور را پیامک کن
 * (به‌جای نمایش در صفحه تشکر از خرید).
 * این تابع توسط account.php (قلاب woocommerce_checkout_order_processed)
 * صدا زده می‌شود.
 */
