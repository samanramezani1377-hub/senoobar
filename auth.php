...
<div class="snb-auth" dir="rtl">
    ...
    <div class="snb-auth-tabs">
        ...
        <div class="snb-auth-card">
            ...
            <form method="post" class="snb-form" id="snb-register-form" onsubmit="return false;">
                ...
                <button type="submit" id="snb-reg-send" class="snb-btn snb-btn-outline snb-btn-block">ارسال کد تأیید</button>
        ...
        <div class="snb-auth-subtabs">
            ...
            <div class="snb-auth-card">
                ...
                <div class="snb-form" id="snb-otp-form">
                    ...
                    <button type="button" id="snb-otp-send" class="snb-btn snb-btn-outline snb-btn-block">ارسال کد تأیید</button>
    ...
    <div class="snb-auth-card">
        ...
        <div class="snb-form" id="snb-reset-form">
            ...
            <button type="button" id="snb-reset-send" class="snb-btn snb-btn-outline snb-btn-block">ارسال کد تأیید</button>
